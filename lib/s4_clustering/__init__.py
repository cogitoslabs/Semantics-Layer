"""
s4_clustering/__init__.py - Entry point for running the Step 4 Corpus Engineering & Micro-Clustering pipeline.
"""
...
from lib.s4_clustering.embedder import run_embedding
from lib.s4_clustering.clusterer import run_clustering
